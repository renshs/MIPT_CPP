/*
    Во всех предыдущих примерах мы использовали malloc без проверки возвращаемого значения.
    Также мы использовали C-style cast чтобы привести указатель void*, который возвращает malloc к типу char*.
    В этом случае для приведения желательно использовать static_cast.

    В этом варианте эти недостастатки исправлены.
*/
